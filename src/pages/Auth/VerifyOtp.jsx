      ...
      <div className="hidden md:flex w-1/2 relative overflow-hidden bg-[#154b23]">
        ...
        <div className="absolute inset-0 z-20 flex flex-col p-12 text-white justify-between">
          ...
          <div className="flex flex-col mb-20 max-w-lg">
            <h3 className="text-3xl font-bold mb-4 leading-tight text-right">تحقق من بريدك الإلكتروني</h3>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8 bg-[#fbf9f6]">
        <div className="w-full max-w-md">
          <div className="text-right mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">أدخل كود التحقق</h1>
            ...
            <div className="flex gap-3 justify-center" onPaste={handlePaste} dir="ltr">
              {otp.map((digit, index) => (
                <input
                  ...
                  className={`w-12 h-14 text-center text-xl font-bold rounded-lg border transition-all outline-none bg-white
            ...
            <div className="text-center mt-6 space-y-3">
              <p className="text-sm text-gray-600">
                ...
                <button
                  ...
                  className="text-[#154b23] font-bold hover:underline disabled:opacity-50 cursor-pointer"
                >
