        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            <div
              ...
              className="feature-card bg-white rounded-2xl p-8 shadow-md border border-gray-200 transition-all duration-300 flex flex-col justify-between text-right group hover:-translate-y-1.5 hover:shadow-xl hover:border-[#86efac]/40 cursor-pointer"
              dir="rtl"
              data-aos="fade-up"
              ...
              data-aos-once="true"
            >
              {/* Content wrapper — must sit above the ::before fill layer */}
              <div className="relative z-10">
                {/* Icon Container */}
               <div className="w-11 h-11 rounded-2xl bg-[#1b4d2c]/10 flex items-center justify-center text-[#1b4d2c] transition-all duration-300 group-hover:bg-white/20 group-hover:text-white">
  {card.icon}
</div>
                
                {/* Title */}
                <h3 className="font-extrabold text-[#1b4d2c] text-lg mb-3 leading-snug transition-colors duration-300 group-hover:text-white">
  {card.title}
</h3>
                {/* Description */}
