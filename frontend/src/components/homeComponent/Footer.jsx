          ...
          >
            ...
            <ul className="space-y-2.5 text-sm text-emerald-200/60">
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+201201277463" className="hover:text-white transition-colors" dir="ltr">+20 120 127 7463</a>
              </li>
              <li className="flex items-center gap-3">
                <svg className="w-4 h-4 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:sahmah227@gmail.com" className="hover:text-white transition-colors">sahmah227@gmail.com</a>
              </li>
