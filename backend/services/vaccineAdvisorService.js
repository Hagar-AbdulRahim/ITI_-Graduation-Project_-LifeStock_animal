...
5. التزم حرفيًا بالعمر المذكور في age_at_vaccination — لا تجتهد أو تفترض
   ملاءمة اللقاح لعمر خارج النطاق المحدد صراحةً. لو عمر الحيوان خارج
   النطاق، اذكر ذلك بوضوح في notes كـ "تحذير: خارج النطاق العمري
   الموصى به"، ولا تضف تبريرًا من عندك لسبب مناسبته
6. أجب فقط بـ JSON صالح بدون أي نص خارجه وبدون markdown
