...
const { getMe, updateMe, changePassword, updateFcmToken, deleteMe, updatePushSubscription } = require("../controllers/User.controller");
...
router.put("/me/push-subscription", updatePushSubscription);
